            ...
            <div className="flex space-x-4">
              <div className="relative">
                ...
                />
                  ...
                  <Button onClick={() => setIsAddingCoupon(!isAddingCoupon)} className="flex items-center">
          ...
          <div className="mt-4">
            {foundCoupon && (
              <Card className="p-4 bg-gray-100 mt-4">
                ...
                <p>
                  <strong>Code:</strong> {foundCoupon.couponCode}
                </p>
                <p>
                  <strong>Title:</strong> {foundCoupon.title}
                </p>
                <p>
                  <strong>Description:</strong> {foundCoupon.description}
                </p>
                <p>
